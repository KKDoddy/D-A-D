...
public class Pepperoni extends OptionSetDecorator{
    
    OptionSet pizza;

    public Pepperoni(String name, int numberOfChoices, OptionSet pizza) {
    ...
    public Option[] setChoice() {
       ...
       ops[usual.length] = new Option("Pepperoni", 800);
       this.setChoices(ops);
       return ops;
    }
