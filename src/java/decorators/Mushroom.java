...
public class Mushroom extends OptionSetDecorator{
    OptionSet pizza;

    public Mushroom(String name, int numberOfChoices, OptionSet pizza) {
    ...
    public Option[] setChoice() {
       ...
       ops[usual.length] = new Option("Mushroom", 400);
       this.setChoices(ops);
       return ops;
    }
}
