...
public class GreenOlives extends OptionSetDecorator{
    OptionSet pizza;

    public GreenOlives(String name, int numberOfChoices, OptionSet pizza) {
    ...
    public Option[] setChoice() {
       ...
       ops[usual.length] = new Option("Green Olives",1000);
       this.setChoices(ops);
       return ops;
    }
}
